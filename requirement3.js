var fs = require('fs');
 ...
 var readStream = fs.createReadStream('merge1.csv', 'utf8');
...
readStream.on('data', function(chunk) {  
  ...
  var finalData=JSON.stringify(endArr);
  var writeData=fs.createWriteStream("educationCategoryWise.json");
  writeData.write(finalData);
  writeData.end();
// group by end         
